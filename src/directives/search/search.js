...
(function () {
    ...
    var formComponents = {
        ...
        noteTemp: '<div class="{cols}"><div class="{formStyle}" style="position:relative;"><label style="color:red;font-weight:normal;padding-top:5px;">{label}{{{model}}}</label></div></div>',
