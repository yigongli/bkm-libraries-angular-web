(function () {
    ...
    const formComponents = {
        ...
        inputFileBtnTemp: '<button type="button" style="border:0;text-decoration:none;outline:none;" ng-hide="{hideModel}.isHide||{isHide}" ng-disabled="{readModel}.isRead||{isRead}">\
