...
gulp.task('injectAuth', ['stylesAuth'], function () {
    ...
    //console.log('---------------------------------------------------------------------');
    //var sourcesIndex = gulp.src([path.join(conf.paths.src, '/app.js')], {read: false});
    //console.log(path.join(conf.paths.src, '/app/app.js'));
    //console.log('+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++');
    //
    //gulp.src(path.join(conf.paths.src, '/auth.html'))
    //    .pipe($.inject(sourcesIndex, {starttag: '<!-- inject:js:{{ext}} -->'}))
    //    .pipe(gulp.dest(path.join(conf.paths.tmp, '/serve')));
    //
    //console.log('========================================================================');
